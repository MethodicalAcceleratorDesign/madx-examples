...
set output "out_tstTrack_synchr_LHC.ps"; 
#set multiplot
...
# plot data
plot "track.obs0001.p0003" every ::7:0::0 u 7:8 notitle  w p 3 ,\
 "track.obs0001.p0002" every ::7:0::0 u 7:8 notitle  w p 2 ,\
 "track.obs0001.p0001" every ::7:0::0 u 7:8 notitle  w p 1
