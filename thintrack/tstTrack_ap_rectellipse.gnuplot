...
set xlabel "x [m]";
set ylabel "y [m]";
set title "Aperture Test RECTELLIPSE, Real Space X/Y";

set terminal postscript enhanced color;
set output "out_tstTrack_ap_rectellipse.ps"; 
set multiplot

# plot data
plot "out_tstTrack_ap_rectellipseone" every ::10055:0::0 u 3:5 notitle;
