 ...
 s->SetLineColor( 4 );
 rotmatrix[0] =  0.6414565621984245 ;
 rotmatrix[1] =  0.18301270189221927 ;
 rotmatrix[2] =  -0.7450099527916982 ;
 rotmatrix[3] =  -0.6123724356957945 ;
 rotmatrix[4] =  0.7071067811865476 ;
 rotmatrix[5] =  -0.35355339059327373 ;
 rotmatrix[6] =  0.46209682839484933 ;
 rotmatrix[7] =  0.6830127018922193 ;
 rotmatrix[8] =  0.5656502189881232 ;
 m = new TRotMatrix("mtx00011","mtx00011",rotmatrix);
 n = new TNode("NODE00011","NODE00011",s, 1.9615273269014117 , 0.6771694335440831 , 8.380144691885896 ,m);
 s = new TTUBE("DRIFT00012","DRIFT00012","void", 0.05 , 0.6 );
 s->SetLineColor( 18 );
 rotmatrix[0] =  0.6414565621984242 ;
 rotmatrix[1] =  0.18301270189221908 ;
 rotmatrix[2] =  -0.7450099527916985 ;
 rotmatrix[3] =  -0.6123724356957944 ;
 rotmatrix[4] =  0.7071067811865478 ;
 rotmatrix[5] =  -0.3535533905932734 ;
 rotmatrix[6] =  0.4620968283948499 ;
 rotmatrix[7] =  0.6830127018922192 ;
 rotmatrix[8] =  0.565650218988123 ;
 m = new TRotMatrix("mtx00012","mtx00012",rotmatrix);
 n = new TNode("NODE00012","NODE00012",s, 2.8643827149841807 , 1.8119223904352868 , 9.085859201621634 ,m);
